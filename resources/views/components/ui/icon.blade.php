@props(['name' => 'check-circle', 'size' => 'h-5 w-5'])

<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {{ $attributes->merge(['class' => sprintf('%s inline-block', $size)]) }}>
    @if ($name == 'exclamation')
