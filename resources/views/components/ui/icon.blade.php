@props(['name' => 'check-circle', 'size' => 5])

<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {{ $attributes->merge(['class' => sprintf('h-%d w-%d inline-block', $size, $size)]) }}>
    @if ($name == 'exclamation')
