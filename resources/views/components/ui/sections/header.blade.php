    ...
    <x-base.container class="px-3 flex py-2 items-center">
        ...
        <div class="flex-1 flex items-center justify-between">
            ...
            <div class="flex-1 flex justify-center">
                <x-ui.sections.header.button class="bg-pf-darkblue hover:bg-pf-lightblue active:bg-pf-midblue mr-2" href="{{ route('matcher.index') }}">Find group</x-ui.sections.header.button>
                <x-ui.sections.header.button class="bg-pf-darkblue hover:bg-pf-lightblue active:bg-pf-midblue mr-10" href="{{ route('matcher.create') }}">Start group</x-ui.sections.header.button>
            </div>
