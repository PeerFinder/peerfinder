...
class NewMemberInGroup extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                ...
                ->subject(__('mail/peergroup.subject_user_joined_group', ['user_name' => $this->user->name]))
                ->line(__('mail/peergroup.notification_user_joined_group', ['user_name' => $this->user->name, 'title' => $this->pg->title]))
